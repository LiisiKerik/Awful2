...
module Naming (
  ...
  naming ::
    (
      ...
      Err ((Map' Location', Map' Location', Map' Location', Map' (Map' Location')), Tree_5))
  ...
  naming_1 ::
    (
      ...
      Tree_2 ->
      (Map' Location', Map' Location', Map' Location', Map' (Map' Location')) ->
      Err (Tree_4, (Map' Location', Map' Location', Map' Location', Map' (Map' Location'))))
  ...
  naming_2 :: String -> Tree_4 -> Map' Location' -> Err Tree_5
  ...
  naming_alg_pattern :: String -> Alg_pat_7 -> StateT (Map' Location') Err Alg_pat_1
  ...
  naming_args :: String -> [(Name, t)] -> Map' Location' -> Err [(String, t)]
  naming_args a b c =
    case b of
      [] -> Right []
      (d, e) : f -> runStateT (naming_name a d) c >>= \(h, g) -> (:) (h, e) <$> naming_args a f g
  naming_argument :: (String -> t -> StateT (Map' Location') Err u) -> String -> (t, v) -> StateT (Map' Location') Err (u, v)
  naming_argument a e (b, c) = StateT (\d -> first (flip (,) c) <$> runStateT (a e b) d)
  naming_arguments ::
    (String -> t -> StateT (Map' Location') Err u) -> String -> [(t, v)] -> StateT (Map' Location') Err [(u, v)]
  naming_arguments a = naming_list (naming_argument a)
  naming_case :: String -> Map' Location' -> (Alg_pat_7, Expression_9) -> Err (Alg_pat_1, Expression_1)
  naming_case a g (c, d) = runStateT (naming_alg_pattern a c) g >>= \(f, e) -> (,) f <$> naming_expression a d e
  naming_cat_0 :: String -> Cat_1 -> StateT (Map' Location', Map' Location') Err Cat_2
  ...
  naming_cat_1 :: String -> Map' Location' -> Cat_2 -> Err Cat_3
  ...
  naming_data_br_2 :: String -> Data_br_1 -> Map' Location' -> Err Data_br_2
  ...
  naming_data_case_1 :: String -> Data_case_6 -> StateT (Map' Location') Err Data_case_1
  naming_data_case_1 a (Data_case_6 b c d) = Data_case_1 b c <$> naming_data_br_1 a d
  naming_data_case_2 :: String -> Data_case_1 -> Map' Location' -> Err Data_case_2
  naming_data_case_2 a (Data_case_1 b c d) e =
    runStateT (naming_names'' a c) e >>= \(f, g) -> Data_case_2 b f <$> naming_data_br_2 a d g
  naming_data_cases_2 :: String -> [Data_case_1] -> Map' Location' -> Err [Data_case_2]
  naming_data_cases_2 a b c =
    case b of
      [] -> Right []
      d : e -> (:) <$> naming_data_case_2 a d c <*> naming_data_cases_2 a e c
  naming_datas_1 :: String -> [Data_6] -> StateT (Map' Location') Err [Data_1]
  naming_datas_1 = naming_list naming_data_1
  naming_datas_2 :: String -> [Data_1] -> Map' Location' -> Err [Data_2]
  ...
  naming_fields :: String -> [(Name, Type_8)] -> StateT (Map' Location') Err [(String, Type_8)]
  naming_fields = naming_arguments naming_name
  naming_form :: String -> Form_6 -> StateT (Map' Location') Err Form_1
  ...
  naming_name :: String -> Name -> StateT (Map' Location') Err String
  naming_name f (Name a c) =
    StateT
      (\d -> bimap (flip (location_err ("definitions of " ++ c)) (Location_1 f a)) ((,) c) (add d c (Library (Location_1 f a))))
  naming_nameexprs :: String -> Map' Location' -> [(Name, Expression_9)] -> Err [(Name, Expression_1)]
  naming_nameexprs a b c =
    case c of
      [] -> Right []
      (d, e) : f -> naming_expression a e b >>= \g -> (:) (d, g) <$> naming_nameexprs a b f
  naming_names'' :: String -> [Name] -> StateT (Map' Location') Err [String]
  naming_names'' = naming_list naming_name
  naming_ops :: String -> Map' Location' -> [Name] -> Err (Map' Location')
  naming_ops a b c =
    case c of
      [] -> Right b
      Name d e : i ->
  ...
  naming_pat :: String -> Pat_2 -> StateT (Map' Location') Err Pat'
  naming_pat a c =
    case c of
